            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    tables = databaseTables.map(function (table) {
                        ...
                        return __assign(__assign({}, table), { highestBet: table.bigBlind, totalHighestBet: table.bigBlind, totalBets: 0, roundPot: roundPot, roundStatus: false, flopStatus: false, turnStatus: false, riverStatus: false, deck: [], cards: [], players: [], sockets: [] });
                    });
